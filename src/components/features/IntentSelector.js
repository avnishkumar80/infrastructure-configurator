...
const IntentSelector = ({ intentQuestions, onSelect, currentIntent, onClose, hasActiveConfig }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 animate-in zoom-in-95 duration-200 relative">
                {onClose && (
                    <button
                        onClick={onClose}
                ...
                <div className="text-center mb-6">
                    <h2 className="text-3xl font-bold text-gray-900 mb-2">Configure Your Environment</h2>
                    <p className="text-gray-500">Answer a few questions to help us tailor the catalog for you.</p>
                </div>
                ...
                <div className="mt-10 flex justify-end">
                    <button
                        ...
                        `}
                    >
                        {showWarning ? 'Update & Reset Configuration' : 'Start Configuration'}
                    </button>
                </div>
